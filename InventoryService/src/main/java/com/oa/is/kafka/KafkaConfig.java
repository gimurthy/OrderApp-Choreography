...
public class KafkaConfig {
	...
	@Bean
	public FulfillmentErrEventConsumer fulfillmentErrEventListener() {
		return new FulfillmentErrEventConsumer();
	}
	
	@Bean
	public PaymentEventConsumer paymentEventListener() {
		return new PaymentEventConsumer();
	}

	@Bean
	public InventoryProcessor createPaymentProcessor() {
