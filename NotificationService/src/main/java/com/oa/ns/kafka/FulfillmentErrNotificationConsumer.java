...
public class FulfillmentErrNotificationConsumer {

	private final Logger logger = LoggerFactory.getLogger(FulfillmentErrNotificationConsumer.class);

	@Autowired
	JSONParser parser;

	@KafkaListener(id = "FulfillmentErrNotificationConsumer", topics = { "${kafka.g-fulfillment-err-topic}" })
