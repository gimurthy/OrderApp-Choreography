...
public class PaymentNotificationConsumer {
	...
	private final Logger logger = LoggerFactory.getLogger(PaymentNotificationConsumer.class);

	@Autowired
	JSONParser parser;

	@KafkaListener(id = "PaymentNotificationConsumer", topics = { "${kafka.g-payment-topic}" })
