...
public class PaymentErrNotificationConsumer {

	private final Logger logger = LoggerFactory.getLogger(PaymentErrNotificationConsumer.class);

	@Autowired
	JSONParser parser;

	@KafkaListener(id = "PaymentErrNotificationConsumer", topics = { "${kafka.g-payment-err-topic}" })
