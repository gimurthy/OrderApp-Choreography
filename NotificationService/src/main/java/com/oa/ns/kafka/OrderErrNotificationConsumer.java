...
public class OrderErrNotificationConsumer {

	private final Logger logger = LoggerFactory.getLogger(OrderErrNotificationConsumer.class);

	@Autowired
	JSONParser parser;

	@KafkaListener(id = "orderErrNotificationConsumer", topics = { "${kafka.g-order-err-topic}" })
